...
file_reactance = open('reflect_z_img_interpol.csv', 'rb')  # open the file for reading
reactance = csv.reader(file_reactance, delimiter=',')   # convert cvs file to python list
file_capacitance = open('reflect_cap_interpol.csv', 'wb') # open the file for writing
