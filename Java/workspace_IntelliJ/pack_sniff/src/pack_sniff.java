...
public class pack_sniff {
    public void run_app () throws Exception {
        ...
        for(int j = 0; j < alldevs.size(); ++j) {
            if(alldevs.get(j).getName().toString().equals("wlan2")) {
        ...
        pcap.setRfmon(1);   //set the device to monitor mode
        ...
        public void nextPacket(PcapPacket packet, String user) {
            ...
            try {
                ...
                if (packet.hasHeader(eth)) {
                    ...
                    //if(temp_src.equals("FC:C2:DE:81:E9:92")){
                        System.out.print(Long.toString(packet.getCaptureHeader().timestampInMillis()) + ": ");
                        System.out.println(temp_src);
                    //}
                    ...
                    if (ms1 > 999) {    // 999 = 1 second
                        ...
                        System.out.println("Number of MACs: " + MAC_addr.size());
