...
public class Main implements DiscoveryListener{    //Creates the Bluetooth Class that implements DiscoveryListener
    ...
    public static void main(String[] args) {
        ...
        Main listener =  new Main();  //Creates a new Bluetooth Listener
    ...
    private static void sendMessageToDevice(String bt_Address){
        try{
            Path path = Paths.get("1234.txt");
            byte[] file = Files.readAllBytes(path);;
            String filename = "1234.txt";
            System.out.println("Connecting to " + bt_Address);
            Connection connection=Connector.open(bt_Address);
